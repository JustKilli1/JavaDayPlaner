package javadayplaner.logging.output;

import javadayplaner.logging.ILogger;
import javadayplaner.logging.LogLevel;
import javadayplaner.logging.LoggingUtils;
import javadayplaner.logging.files.FileHandler;
...
public class FilePrinter implements IOutputPrinter {
    ...
    private String formatMessage(List<String> message) {
        return (message == null) ? "" : String.format("%nMessage: %s", LoggingUtils.getMessageStr(message, false));
    }
